  ...
  module PaginationHelper
    ...
    def page_entries_info(collection, options = {})
      ...
      if collection.total_pages < 2
        t('trestle.helpers.page_entries_info.one_page.display_entries', entry_name: entry_name, count: collection.total_count)
      else
        ...
        t('trestle.helpers.page_entries_info.more_pages.display_entries', entry_name: entry_name, first: first, last: last, total: total)
      end.html_safe
    end
  end
end
